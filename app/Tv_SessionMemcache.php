...
class Tv_SessionMemcache extends Memcache
{
    /*
    ...
    function &singleton()
    {
        ...
        if (!is_object($instance)) {
            $instance = &Tv_SessionMemcache::_factory();
...
//            $instance->addServer("127.0.0.1");
    ...
    function & _factory()
    {
        $memsessObj = new Tv_SessionMemcache();
