...
class Tv_View_AdminAvatarList extends Tv_ListViewClass
{
	...
	function preforward()
	{
		...
		if($this->af->get('avatar_status') == "") $this->af->set('avatar_status', 1);
		...
		$ac = $u->getAttrList('avatar_category');
		if($this->af->get('avatar_category_id')) $this->af->setApp('avatar_category_name', $ac[$this->af->get('avatar_category_id')]['name']);
