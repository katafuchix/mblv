 ...
 * @package    MBLV
 */
class Tv_View_UserAvatarConfigFirst extends Tv_ListViewClass
{
	/**
	 *  画面表示前処理
	 *
	...
	{
		// 選択条件
		$sqlWhere = "ac.avatar_system_category_id = 1 AND ac.avatar_category_id = a.avatar_category_id AND a.first_avatar = 1";
		...
		// リストビュー
		$this->listview = array(
			'action_name'	=> 'user_avatar_config_first',
			'sql_select'	=> '*',
