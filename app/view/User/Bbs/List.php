...
class Tv_View_UserBbsList extends Tv_ListViewClass_Bbs
{
	...
	function preforward()
	{
		...
		// リストビュー
		$sqlWhere = 'b.bbs_status = 1 AND b.to_user_id = ? AND b.from_user_id = fu.user_id';
		...
		$this->listview = array(
			...
			'sql_select' => 
				...
				b.bbs_id,b.bbs_body,b.bbs_created_time, b.image_id,b.bbs_body,b.bbs_notice,b.to_user_id',
