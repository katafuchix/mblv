	...
	function preforward()
	{
		...
		foreach($communityList[1] as $community)
		{
			...
			$updateArticleList = $communityArticle->searchProp(
				array('community_article_id', 'community_article_title', 'community_article_comment_time', 'community_id'),
				array(
			...
			if( ($updateArticleList[0] > 0) && ($community_status[1][0]['community_status'] == 1) ){
