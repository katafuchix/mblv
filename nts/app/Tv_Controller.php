...
require_once 'function.adpoint.php';
require_once 'function.napaboard.php';
...
// 影響がないので書き換えない
//require_once $lib . '/Ethna/class/Plugin/Handle/Ethna_Plugin_Handle_ClearCache.php';
...
require_once 'Tv_SpgvPoint.php';
require_once 'Tv_SpgvUser.php';

require_once 'Tv_Thema.php';
...
class Tv_Controller extends Ethna_Controller
{
	...
	var $smarty_function_plugin = array(
		 ...
		 */
		 ...
		 'smarty_function_adpoint',
		 'smarty_function_napaboard',
	);
...
//			return array('' => $this->db['']);
	...
	function getTemplatedir()
	{
		...
		if($GLOBALS['type'] == 'user'){
			...
			if(TEMPLATE != 'default'){
				if($GLOBALS['check']){
					$template = $template_dir . '/' . TEMPLATE . '_check';
				}else{
