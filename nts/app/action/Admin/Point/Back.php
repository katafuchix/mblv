...
/**
 * ポイントバックアクションフォームクラス
 * 広告業者側アプリからの広告登録に対する結果取得と広告登録したユーザへのポイントバック処理
 *
 * @author Technovarth 
 * @access public 
 * @package SNSV
...
class Tv_Action_AdminPointBack extends Tv_ActionClass
{
	/**
	...
	function perform()
	{
		...
		$file_path = $this->config->get('pointback_log_path').date('Ymd').'.log';
