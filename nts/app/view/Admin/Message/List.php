	...
	function preforward()
	{
		...
		$this->listview = array(
			'sql_select'	=> 
				...
				m.message_id,m.message_title,m.message_body,m.message_status,m.message_checked,m.message_created_time,m.message_updated_time,m.message_deleted_time',
			'sql_from'	=> 'user as fu,user as tu,message as m',
			'sql_where'	=> $sqlWhere,
