...
<div id="two_column">
	...
	<div id="main" class="floatr">
		...
		<!-- ここからメインコンテンツ-->
			...
			{$ft.menu_icon.name}<a href="?action_admin_cms_edit=true&cms_type=1">{$ft.ad.name}ポータルCMS</a>
			...
			<table class="sheet">
				...
				<tr>
					...
					<td {if $app.ad_status_active}class="active"{/if}>{form_input name="ad_status" emptyoption=""}</td>
				</tr>
				<tr>
					<th></th>
					<td></td>
			...
			<table class="sheet" id="list">
				...
				<tr>
					...
					<td>{$i.ad_name}</td>
					<td>{php} echo $ac[$this->_tpl_vars['i']['ad_category_id']]['name'];{/php}</td>
