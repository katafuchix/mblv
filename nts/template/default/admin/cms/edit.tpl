...
<div id="two_column">
	...
	<div id="main" class="floatr">
		<div id="mainC">
			...
			{form ethna_action="admin_cms_edit_do"}
			{form_input name="cms_type"}
			<table class="sheet" id="w200">
				<tr>
					<th>{form_name name="cms_type"}</th>
					<td>{$config.cms_type[$form.cms_type].name}</td>
				</tr>
				<tr>
					<th>{form_name name="cms_html1"}</th>
					<td>
						...
						{form_input name="cms_html1" cols="50" rows="20"}
						<div>
							<b>タグリファレンス</b><br />
				...
				<tr>
					<th>{form_name name="cms_html3"}</th>
					<td>{form_input name="cms_html3" cols="50" rows="20"}</td>
				</tr>
				<tr>
					<th>{form_name name="cms_html2"}</th>
					<td>{form_input name="cms_html2" cols="50" rows="20"}</td>
				</tr>
				<tr>
					<th>端末振り分け</th>
					<td>
						<div style="float:left">
						{form_name name="low_term_d"}<br />
						{form_input name="low_term_d" rows="30" cols="20"}
						</div>
						<div style="float:left">
						{form_name name="low_term_a"}<br />
						{form_input name="low_term_a" rows="30" cols="20"}
						</div>
						<div style="float:left">
						{form_name name="low_term_s"}<br />
						{form_input name="low_term_s" rows="30" cols="20"}
						</div>
						<br class="clear" />
					</td>
				</tr>
