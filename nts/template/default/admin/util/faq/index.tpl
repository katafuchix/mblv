					...
					<td valign="top">
						<ul>
							...
							<ul>
								...
								<li><a href="?action_admin_util=true&page=faq_community_add&TB_iframe=true&height=700&width=700" title="コミュニティ登録" class="thickbox">コミュニティ登録</a></li>
								...
								<li><a href="?action_admin_util=true&page=faq_black_list_list&TB_iframe=true&height=700&width=700" title="ブラックリスト管理" class="thickbox">ブラックリスト管理</a></li>
					...
					<td valign="top">
						<ul>
							...
							<ul>
								...
								<li><a href="?action_admin_util=true&page=faq_point_list&TB_iframe=true&height=700&width=700" title="ナパポ管理" class="thickbox">ナパポ管理</a></li>
