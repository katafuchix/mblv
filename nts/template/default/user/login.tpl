...
<div align="left" style="text-align:left;font-size:small;">
	...
	{form ethna_action="user_login_do" action="`$script`?guid=ON"}
		<br />
		<br />
		<div style="text-align:center;font-size:small;">{form_submit name="easy_login" value="　かんたんﾛｸﾞｲﾝ　"}</div><br />
		<br />
		...
		<div style="text-align:center;font-size:small;">{form_submit value="　ﾛｸﾞｲﾝ　"}</div><br />
	{/form}
	<span style="color:{$menucolor}">{$ft.menu_icon.name}</span><a href="?action_user_remind=true">ﾊﾟｽﾜｰﾄﾞを忘れてしまった方</a>
</div>
<!--コンテンツ終了-->
