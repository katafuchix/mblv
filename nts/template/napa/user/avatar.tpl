...
<!--タイトル-->
<img src="img_napa/top/np_avatar03.gif" alt="NAPATOWNｱﾊﾞﾀｰ"><br />
{html_style type="title" title="`$ft.avatar.name`TOP" bgcolor=$title_bgcolor fontcolor=$title_fontcolor}
