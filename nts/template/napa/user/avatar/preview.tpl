...
<div align="left" style="text-align:left;font-size:small;">
	...
	<div align="center" style="text-align:center;font-size:small;">
		<img src="?action_user_file_avatar_preview=true&width=100&height=100&place=cart&SESSID={$SESSID}&uniqid={$smarty.now|uniqid}"><br />
	...
	{foreach from=$app.user_avatar_wear_list item=item}
		{$item.avatar_name}{if $item.user_avatar_wear==1}(<a href="?action_user_avatar_change_do=true&cmd=off&user_avatar_id={$item.user_avatar_id}&return=preview">脱ぐ</a>)<br />
		{else}(<a href="?action_user_avatar_preview=true&cmd=off&cart_avatar_id={$item.avatar_id}">脱ぐ</a>)<br />
		{/if}
	{/foreach}
	<br />
	{if $form.avatar_id}
