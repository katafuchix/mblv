...
<div align="left" style="text-align:left;font-size:small;">
	...
	{if $app.message.image_id}
		...
		<a href="?action_user_file_image_view=true&image_id={$app.message.image_id}&message_id={$form.message_id}&message_type=sent">
		<img src="f.php?type=image&id={$app.message.image_id}&attr=t&SESSID={$SESSID}" alt="画像">
		</a>
		</div>
	{/if}
	<br />
