...
<div style="text-align:center; font-size:xx-small;">
	...
	{if $session.user.user_id && !$app.logout}
		<a href="?action_user_home=true">ﾏｲﾍﾟｰｼﾞ</a><br /><br />
		<a href="?action_user_invite=true">友達招待</a><br /><br />
	{else}
		<!--ログイン開始-->
		...
		<!--ログイン終了-->
	{/if}
<font size="1"><a href="?action_user_decomail=true">ﾃﾞｺﾒ</a>/<a href="?action_user_sound=true">着うた</a>/<a href="?action_user_game=true">ｹﾞｰﾑ</a>/<a href="fp.php?code=fortune_index">診断･占い</a></font><br><br>
</div>
<!--NEWS-->
<!-- napatoen -->
...
<div style="background-color:#ccffff; text-align:right;">
	<a href="?action_user_news_list=true"><span style="font-size:xx-small; color:#5577CC">もっと見る</span></a><br />
</div>
...
<a href="?action_user_game=true"><span style="font-size:x-small;">もちまるTouch!DEｹﾞｰﾑ</span></a><br />
...
<a href="?action_user_game=true"><span style="font-size:x-small;">世界釣り紀行</span></a><br />
<span style="font-size:xx-small">操作がとってもｼﾝﾌﾟﾙな釣りｹﾞｰﾑ｡幻の大物を狙い世界中の海を駆け巡れ</span><br /><br />
</div>
...
<span style="font-size:xx-small">新着!『異性にﾓﾃる星座』配信中</span><br /><br /><br />
</div>
<div style="background-color:#FFFFFF; text-align:right; font-size:xx-small;">
...
<div style="background-color:#FFFFFF; text-align:left;">
<a href="?action_user_sound=true"><span style="font-size:x-small;">ナパタウン独占配信!!</span></a><br />
...
<a href="?action_user_avatar=true"><span style="font-size:xx-small;">おしゃれｱｲﾃﾑ<br />ｱｸｾ&ﾍﾟｯﾄも<br />いっぱい!!!</span></a><br /><br />
</div>
<br /><br />
...
<a href="?action_user_decomail=true"><span style="font-size:xx-small;">注目ﾃﾞｺﾒ<br />ﾗﾝｷﾝｸﾞ<br />要ﾁｪｯｸ☆</span></a><br />
<br /><br /><br />
</div>
...
<span style="font-size:x-small; color:#BBCCFF">■</span><a href="fp.php?code=guide_policy">ﾌﾟﾗｲﾊﾞｼｰﾎﾟﾘｼｰ</a><br />
...
<span style="font-size:x-small; color:#8899FF">■</span><a href="fp.php?code=guide_device">対応機種一覧</a><br />
