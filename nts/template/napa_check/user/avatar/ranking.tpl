...
<!--タイトル-->
{html_style type="title" title="`$ft.avatar.name`ｱｲﾃﾑﾋﾟｯｸｱｯﾌﾟ" bgcolor=$title_bgcolor fontcolor=$title_fontcolor}
...
<div align="left" style="text-align:left;font-size:small;">
	...
	{foreach from=$app.ranking item=item name=avatar key =k}
		...
		<img src="?action_user_file_avatar_view=true&avatar_id={$item.avatar_id}&width={$config.avatar_t_width}&height={$config.avatar_t_height}&SESSID={$SESSID}" style="float:left;">
			第{$k+4}位<br />
			<span>
