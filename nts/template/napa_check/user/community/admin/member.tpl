...
<div align="left" style="text-align:left;font-size:small;">
	...
	{foreach from=$app.memberList item=item}
		{if $item.user_status == 2}
			...
			<a href="?action_user_community_admin_power_give_confirm=true&community_id={$form.community_id}&community_member_id={$item.community_member_id}&new_admin_user_id={$item.new_admin_user_id}">管理権を渡す</a>
		<hr color="{$hrcolor}" style="border:solid 1px {$hrcolor};">
		{/if}
	{/foreach}
