...
<div align="left" style="text-align:left;font-size:small;">
	...
	{form action="$script" ethna_action="user_profile_edit_do"}
		...
		<br />
		{form_input name="prefecture_id" emptyoption="未設定"}
		...
		<br />
		{form_input name="job_family_id" emptyoption="未設定"}
		...
		<br />
		{form_input name="business_category_id" emptyoption="未設定"}
		...
		<br />
		{form_input name="work_location_prefecture_id" emptyoption="未設定"}
