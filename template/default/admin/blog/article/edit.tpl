		...
		<div id="mainC">
			...
			<table class="sheet" id="w200">
				...
				<tr>
					...
					<td>{form_input name="blog_article_body" cols="80" rows="20"}</td>
				</tr>
				<tr>
					<th>画像</th>
					<td>
				...
				<tr>
					<th>{form_name name="blog_article_public"}<br /><span class="required"></span></th>
					<td>{form_input name="blog_article_public"}</td>
				</tr>
				<tr>
					<th></th>
					<td>{form_submit value="　`$ft.blog_article.name`編集　"}</td>
				</tr>
			</table>
			{/form}
			<!-- ここまでメインコンテンツ-->
