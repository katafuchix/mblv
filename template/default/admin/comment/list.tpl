			...
			<table class="sheet">
				<tr>
					...
					<td {if $app.comment_created_active}class="active"{/if} nowrap>
						...
						{form_input name="comment_created_month_end" emptyoption=""}月
				...
				<tr>
					...
					<td {if $app.comment_updated_active}class="active"{/if} nowrap>
						...
						{form_input name="comment_updated_month_end" emptyoption=""}月
				...
				<tr>
					...
					<td {if $app.article_deleted_active}class="active"{/if} nowrap>
						...
						{form_input name="comment_deleted_month_end" emptyoption=""}月
				...
				<tr>
					...
					<td {if $app.comment_status_active}class="active"{/if}>{form_input name="comment_status"}</td>
				</tr>
				<tr>
