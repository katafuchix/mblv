...
<div id="two_column">
	...
	<div id="main" class="floatr">
		<div id="mainC">
			<!-- ここからメインコンテンツ-->
			<h2>{$ft.community.name}{$ft.community_comment.name}検索</h2>
			<blockquote><a href="?action_admin_util=true&page=faq_community_comment_list&keepThis=true&TB_iframe=true&height=700&width=700" class="thickbox">{$ft.community.name}{$ft.community_comment.name}検索FAQ</a></blockquote>
			<div class="entry_box">
			...
			<table class="sheet">
				...
				<tr>
					<td class="checkedrow" colspan=11 align="right">下記{$ft.community_comment.name}の{$ft.community_comment_checked.name}ステータスを更新する{form_submit name="update" value="　実　行　"}</td>
				</tr>
				...
				{/foreach}
				<tr>
					<td class="checkedrow" colspan=11 align="right">上記{$ft.community_comment.name}の{$ft.community_comment_checked.name}ステータスを更新する{form_submit name="update" value="　実　行　"}</td>
				</tr>
			</table>
			{/form}
