...
<div id="two_column">
	...
	<div id="main" class="floatr">
		<div id="mainC">
			...
			<blockquote><a href="?action_admin_util=true&page=faq_community_list&keepThis=true&TB_iframe=true&height=700&width=700" class="thickbox">{$ft.community.name}検索FAQ</a></blockquote>
			<!-- ここからメインコンテンツ-->
			<div class="entry_box">
			...
			<table class="sheet">
				...
				<tr>
					...
					<td {if $app.community_status_active}class="active"{/if}>{form_input name="community_status"}</td>
			...
			<table class="sheet">
				...
				<tr>
					<td class="checkedrow" colspan=10 align="right">下記コミュニティの監視ステータスを更新する{form_submit name="update" value="　実　行　"}</td>
				</tr>
				...
				{/foreach}
				<tr>
					<td class="checkedrow" colspan=10 align="right">上記コミュニティの監視ステータスを更新する{form_submit name="update" value="　実　行　"}</td>
				</tr>
			</table>
			{/form}
