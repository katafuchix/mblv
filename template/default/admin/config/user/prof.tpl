...
<div id="two_column">
		...
		<div id="main" class="floatr">
			<div id="mainC">
				<!-- ここからメインコンテンツ-->
				<h2>プロフィール項目変更</h2>
				<blockquote><a href="?action_admin_util=true&page=faq_profile_edit&keepThis=true&TB_iframe=true&height=700&width=700" class="thickbox">プロフィール項目変更FAQ</a></blockquote>
				<div class="entry_box">
