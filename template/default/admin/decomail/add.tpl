	...
	<div id="main" class="floatr">
		<div id="mainC">
			...
			<table class="sheet" id="w200">
				<tr>
					<th>{form_name name="decomail_name"}<br /><span class="required"></span></th>
					<td>{form_input name="decomail_name" size=50}</td>
				</tr>
				<tr>
					<th>{form_name name="decomail_desc"}<br /><span class="required"></span></th>
				...
				<tr>
					<th>{form_name name="decomail_category_id"}<br /><span class="required"></span></th>
				...
				<tr>
					<th>{form_name name="decomail_start_time"}</th>
					<td>
						...
						{form_input name="decomail_start_min" emptyoption=""}分から配信
					</td>
				</tr>
				<tr>
					<th>{form_name name="decomail_end_time"}</th>
					<td>
						...
						{form_input name="decomail_end_min" emptyoption=""}分まで配信
					</td>
				</tr>
				<tr>
					<th></th>
