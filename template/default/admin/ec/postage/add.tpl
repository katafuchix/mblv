			...
			<div id="mainC">
				...
				{elseif $form.postage_type == 3}
					...
					<tr>
						...
						<td>
							<input type="text" name="postage_total_price_value" value="0" maxlength="1000000" disabled>±ß
				...
				{elseif $form.postage_type == 4}
					...
					<tr>
						...
						<td>
							<input type="text" name="postage_total_piece_value" value="0" maxlength="1000000" disabled>±ß
				...
				{/if}
					<tr>
						<th></th>
						<td>{form_input name="add" value="¡¡ÅÐÏ¿¡¡"}</td>
					</tr>
				</table>
