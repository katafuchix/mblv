...
<div id="two_column">
	...
	<div id="main" class="floatr">
		<div id="mainC">
			...
			<table class="sheet">
				<tr>
					...
					<td {if $app.file_upload_active}class="active"{/if} nowrap>
						{form_input name="file_upload_year_start"}年
						{form_input name="file_upload_month_start"}月
						{form_input name="file_upload_day_start"}日
						〜
						{form_input name="file_upload_year_end"}年
						{form_input name="file_upload_month_end"}月
						{form_input name="file_upload_day_end"}日
					</td>
			...
			選択情報{form_input name="type"}{form_submit values="実行"}
			{/form}
