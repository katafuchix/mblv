	...
	<div id="main" class="floatr">
		<div id="mainC">
			...
			<table class="sheet" id="w200">
				<tr>
					<th>{form_name name="sound_name"}<br /><span class="required"></span></th>
					<td>{form_input name="sound_name" size=50}</td>
				</tr>
				<tr>
					<th>{form_name name="sound_desc"}<br /><span class="required"></span></th>
				...
				<tr>
					<th>{form_name name="sound_category_id"}<br /><span class="required"></span></th>
				...
				<tr>
					<th>{form_name name="sound_start_time"}</th>
					<td>
						...
						{form_input name="sound_start_min" emptyoption=""}分から配信
					</td>
				</tr>
				<tr>
					<th>{form_name name="sound_end_time"}</th>
					<td>
						...
						{form_input name="sound_end_min" emptyoption=""}分まで配信
					</td>
				</tr>
				<tr>
					<th></th>
