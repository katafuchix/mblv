...
<div id="two_column">
	...
	<div id="main" class="floatr">
		<div id="mainC">
			<!-- ここからメインコンテンツ-->
			<h2>{$ft.sound_category.name}編集</h2>
			<div class="entry_box">
			...
			<table class="sheet" id="w200">
				...
				<tr>
					<th>{form_name name="sound_category_name"}<br /><span class="required"></span></th>
					<td>{form_input name="sound_category_name" size="50"}</td>
				</tr>
				<tr>
					<th>{form_name name="sound_category_desc"}<br /><span class="required"></span></th>
					<td>{form_input name="sound_category_desc" size="50"}</td>
				</tr>
				<tr>
					<th>{form_name name="sound_category_file1"}</th>
					<td>
						{if $form.sound_category_file1}<img src="f.php?file=sound/{$form.sound_category_file1}" style="float:left;">{/if}
