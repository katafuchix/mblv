...
<div align="left" style="text-align:left;font-size:small;">
	...
	{/if}
	<!--
	{if $app.article.movie_id}
		<div align="center" style="text-align:center;font-size:small;">
		<a href="?action_user_file_get=true&id={$app.article.movie_id}&blog_article_id={$form.blog_article_id}"><img src="f.php?type=image&id={$app.article.movie_id}&attr=t&SESSID={$SESSID}" alt="画像"></a><br />
		</div>
	{/if}
	-->
	<div align="center" style="text-align:center;font-size:small;">
...
<div align="left" style="text-align:left;font-size:small;">
	{foreach from=$app.listview_data item=item key=k}
		...
		{if $app.article.user_id == $session.user.user_id && $item.blog_comment_notice==1}<span style="color:#FF0000">{/if}
		{$item.blog_comment_body|nl2br}
		{if $app.article.user_id == $session.user.user_id && $item.blog_comment_notice==1}</span>{/if}
		{if $item.image_id}
			<div align="center" style="text-align:center;font-size:small;">
