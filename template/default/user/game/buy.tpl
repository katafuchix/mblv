...
<div align="left" style="text-align:left;font-size:small;">
	...
	&nbsp;{$form.game_point}{$ft.point_unit.name}<br />
	<a href="?action_user_game_score_list=true&game_id={$form.game_id}">ﾗﾝｷﾝｸﾞ</a><br />
	<a href="fp.php?code=system_game_device">対応機種</a><br />
	<div align="center" style="text-align:center;font-size:small;">
...
<div align="left" style="text-align:left;font-size:small;">
	...
	{form action="$script" ethna_action="user_comment_add_confirm"}
		{form_input name="comment_type" value="2"}
		{form_input name="comment_subid" value="`$form.game_id`"}
		{form_name name="comment_body"}<br />
		{form_input name="comment_body"}<br />
		{form_input name="add" value="確認画面へ"}<br />
	{/form}
</div>
<!--コメント終了-->
