...
<!--ログイン開始-->
<div align="center" style="text-align:center;font-size:small;">
	[[x:0109]<a href="?action_user_login_do=true&easy_login=true&guid=ON">会員入り口</a>
	|
	[x:0107]<a href="fp.php?code=system_regist">会員登録</a>]
</div>
<!--ログイン終了-->
{/if}
