...
<div align="left" style="text-align:left;font-size:small;">
	...
	{if $app.message.image_id}
		<div style="text-align:center;font-size:small;">
			<a href="?action_user_file_image_view=true&image_id={$app.message.image_id}&message_id={$form.message_id}&message_type=received"><img src="f.php?type=image&id={$app.message.image_id}&attr=t&SESSID={$SESSID}" alt="画像"></a>
		</div>
	{/if}
	<br />
	...
	<br />
	<br />
	<span style="color:{$menucolor}">{$ft.menu_icon.name}</span><a href="?action_user_message_list_received=true">{$ft.message.name}{$ft.message_receive_box.name}へ戻る</a><br />
	
	{html_style type="title" title="受信`$ft.message.name`削除" bgcolor=$title_bgcolor fontcolor=$title_fontcolor}
	<br />
	この{$ft.message.name}を削除するには下のﾎﾞﾀﾝを押してください｡<br />
	<br />
